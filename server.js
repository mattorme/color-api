...
app.post("/api/palettes", (req, res) => {
  const sql =
    "INSERT INTO palettes (primary_color_hex, secondary_color_hex, tertiary_color_hex, quaternary_color_hex, quinary_color_hex, user_id) values ($1, $2, $3, $4, $5, $6);";
...
app.post("/api/favourites", (req, res) => {
  ...
  console.log(req.body.primary_color_hex);
  // console.log(sql)
  pool.query(sql, [req.body.user_id, req.body.palette_id], (err, db) => {
    if (err) {
      res.json(
        {
          message: "invalid request",
